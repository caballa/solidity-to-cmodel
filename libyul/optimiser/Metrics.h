...
{
public:
	GasMeter(langutil::EVMVersion _evmVersion, bool _isCreation, size_t _runs):
...
public:
	GasMeterVisitor(langutil::EVMVersion _evmVersion, bool _isCreation):
		m_evmVersion(_evmVersion),
		m_isCreation{_isCreation}
	{}
...
private:
	...
	void instructionCosts(dev::eth::Instruction _instruction);
