...
private:
	...
	{
		hash16(static_cast<uint8_t>(_value & 0xFFFF));
		hash16(static_cast<uint8_t>(_value >> 16));
	}
	void hash64(uint64_t _value)
	{
		hash32(static_cast<uint8_t>(_value & 0xFFFFFFFF));
		hash32(static_cast<uint8_t>(_value >> 32));
	}
